...
#show: project.with(
  ...
  changelog: (
    "1.0.0", "2024-03-04", p.favaron, "", "Stesura del verbale",
  ),
)
...
Inoltre si è data un'occhiata a quanto fatto in relazione all'automazione dei test e la gestione in generale della repository per favorire una continuous integration e delivery.\
...
table(
  ...
  [Analisi dei Requisiti],[Continuare il miglioramento dei contenuti e la modellazione], [\#1563],
