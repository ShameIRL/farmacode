...
#table(
  ...
  [RDF 28], [L'utente che ha scelto di effetuare un fltraggio può compilare i campi filtri che desidera.], [Soddisfatto],
  [RDF 29], [L'utente che ha effettuato un filtraggio e non, deve poter visualizzare tutti i campi della tabella con i risultati: Codice Articolo, Descrizione Articolo, Linea commerciale, Settore commerciale, Famiglia commersciale e Sotto-famiglia commerciale.], [Soddisfatto],
  ...
  [RDF 35], [L'utente che effettutato un filtraggio e non, deve poter visualizzare il Codice cliente, la Ragione sociale e la provincia del cliente], [Soddisfatto],
  ...
  [RDF 39], [L'utente che effettutato un filtraggio e non, deve poter visualizzare la data, l'utente l'algoritmo, il topic, il codice Cliente/Prodotto e il top.], [Soddisfatto],
  ...
  [RDF 43], [L'utente che effettutato un filtraggio e non, deve poter visualizzare la data, l'utente, l'ID cliente, l'ID prodotto e l'algoritmo del Feedback], [Soddisfatto],
  ...
  [RDF 45], [L'utente, se ha caricato un dataset esterno, dever poter avviare il training del dataset in maniera da poterlo usare per le raccomandazioni.], [Non soddisfatto],
  ...
  [RDF 49], [L'utente se vsualizza le raccomandazioni più attendibili, deve poter vedere l'ID Cliente, l'ID prodotto della raccomandazione.], [Non soddisfatto],
