...
#show: project.with(
  ...
  changelog: (
    "1.2.0", "2024-03-04", p.bomben, "", "Correzione e miglioramento",
...
#table(
  ...
  [ROF 10], [L'utente, una volta autenticato, deve poter effettuare il Logout tramite il pulsante presente nella schermata principale.], [UC5],
  [ROF 11], [L'utente, una volta autenticato, deve poter accedere alla funzione "Ricerca" nella schermata principale.], [UC6],
  ...
  [RDF 18], [Nel caso la ricerca non andasse a buon fine, l'utente deve visualizzare un messaggio di errore che indica che la ricerca non è terminata correttamente.], [UC14],
  ...
  [RDF 21], [L'utente, una volta autenticato, deve poter accedere alla funzione "Catalogo Prodotti" nella schermata principale.], [UC8],
  ...
  [RDF 27], [L'utente, una volta autenticato, deve poter accedere alla funzione "Lista clienti" nella schermata principale.], [UC10],
  ...
  [RDF 31], [L'utente, una volta autenticato, deve poter accedere alla funzione "Statistiche mensili" nella schermata principale.], [UC11],
  ...
  [RDF 35], [L'utente, una volta autenticato, deve poter accedere alla funzione "Cronologia ricerche" nella schermata principale.], [UC12],
  ...
  [RDF 39], [L'utente, una volta autenticato, deve poter accedere alla funzione "Cronologia feedback" nella schermata principale.], [UC13],
